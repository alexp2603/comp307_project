  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
                <div class="navbar-header">
                        ...
                        <a class="navbar-brand" style="font-size: 35px;padding-top: 20px" href="#">Tutor</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                        ...
                        {
                        $name = $_SESSION["NAME"];
                        echo("<li class='signin' style='padding-top: 8px'><a href='availabletutors.php'>Available Tutors</a></li>");
